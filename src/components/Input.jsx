...
const Input = ({id,label, type = 'text', ...props}) => {
  return (
    <div className='relative form-floating'>
        <input id={id} type={type} name='email' placeholder={label} className='form-control w-full block border rounded placeholder:text-transparent cursor-pointer border-gray-300 peer h-[calc(3.5rem+2px)]  focus:pt-[1.625rem] focus:pb-[0.625rem]' {...props}/>
